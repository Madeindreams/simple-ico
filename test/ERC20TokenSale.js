...
contract('ERC20TokenSale', function(accounts) {
  ...
  it('initializes the contract with the correct values', function() {
    return ERC20TokenSale.deployed().then(function(instance) {
  ...
  it('facilitates token buying', function() {
    return ERC20Token.deployed().then(function(instance) {
      ...
      return ERC20TokenSale.deployed();
  ...
  it('ends token sale', function() {
    return ERC20Token.deployed().then(function(instance) {
      ...
      assert.equal(balance.toNumber(), 99999000, 'returns all unsold dapp tokens to admin');
    ...
    // assert.equal(balance.toNumber(), 0);
      return web3.eth.getBalance(tokenSaleInstance.address)
        ...
        //console.log('Token Sold '+ tokenSaleInstance.tokensSold);
